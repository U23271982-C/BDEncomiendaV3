...
(2, 'Asignado a Ruta Lima-Cusco', '2023-01-01'),
(3, 'Revisión técnica aprobada', '2023-02-10'),
(4, 'Reparación de motor completada', CONVERT(DATETIME,'2023-03-20', 102)),
(5, 'Asignado a Ruta Lima-Piura', CONVERT(DATETIME,'2023-03-25', 102)),
(6, 'Cambio de aceite realizado', CONVERT(DATETIME,'2023-04-10', 102)),
(7, 'Mantenimiento preventivo completado', CONVERT(DATETIME,'2023-05-15', 102)),
(8, 'Asignado a Ruta Lima-Trujillo', CONVERT(DATETIME,'2023-06-05', 102)),
(9, 'Revisión técnica programada', CONVERT(DATETIME,'2023-07-01', 102)),
(10, 'Vehículo en mantenimiento', CONVERT(DATETIME,'2023-08-15', 102));
/*Cargo*/
...
VALUES 
('Juan', 'Pérez', 1,CONVERT(DATETIME,'2020-01-15', 102)),
('Ana', 'López', 2, CONVERT(DATETIME, '2019-03-22', 102)),
('Carlos', 'Gómez', 1, CONVERT(DATETIME, '2021-07-10', 102)),
('María', 'Fernández', 8, CONVERT(DATETIME, '2022-04-01', 102)),
('José', 'Martínez', 1, CONVERT(DATETIME, '2018-06-25', 102)),
('Luis', 'Rodríguez', 1, CONVERT(DATETIME, '2020-11-19', 102)),
('Sofía', 'García', 4, CONVERT(DATETIME, '2017-09-13', 102)),
('David', 'Hernández',1, CONVERT(DATETIME, '2023-02-05', 102)),
('Laura', 'Mendoza', 10, CONVERT(DATETIME, '2016-12-30', 102)),
('Ricardo', 'Torres',1, CONVERT(DATETIME, '2019-05-20', 102));
	COMMIT TRANSACTION;
END TRY
BEGIN CATCH
...
VALUES
(1, '2021-01-15T14:30:00','Empleado contratado como conductor para Sucursal Lima.'),
(2, '2021-06-01T14:30:00','Empleado contratado como conductor para Sucursal Arequipa.'),
(3, '2020-11-20T14:30:00','Empleado contratado como administrador para Sucursal Lima.'),
(4, '2022-02-10T14:30:00','Empleado contratado como supervisor de ruta en Sucursal Trujillo.'),
(5, '2019-09-15T14:30:00','Empleado contratado como mecánico en Sucursal Lima.'),
(6, '2021-03-18T14:30:00','Empleado contratado como conductor para Sucursal Piura.'),
(7, '2022-07-01T14:30:00', 'Empleado contratado como asistente administrativo en Sucursal Ica.'),
(8, '2020-05-12T14:30:00', 'Empleado contratado como conductor para Sucursal Tacna.'),
(9, '2018-08-10T14:30:00', 'Empleado contratado como supervisor de logística en Sucursal Lima.'),
(10, '2021-09-25T14:30:00','Empleado contratado como conductor para Sucursal Chiclayo.');
/*AsignacioDeConductor*/
INSERT INTO AsignaciónDeConductores (EmpleadoID, VehículoID, FechaInicio, FechaFin)
VALUES
(1, 1, '2023-01-01T14:30:00', '2023-01-15T00:00:00'),
(2, 2, '2023-01-15T14:30:00', '2023-02-01T00:00:00'),
(3, 3, '2023-02-01T14:30:00', '2023-02-10T00:00:00'),
(4, 4, '2023-02-10T14:30:00', '2023-03-01T00:00:00'),
(5, 5, '2023-03-01T14:30:00', '2023-03-10T00:00:00'),
(6, 6, '2023-03-10T14:30:00', '2023-03-15T00:00:00'),
(7, 7, '2023-03-15T14:30:00', '2023-04-01T00:00:00'),
(8, 8, '2023-04-01T14:30:00', '2023-04-10T00:00:00'),
(9, 9, '2023-04-10T14:30:00', '2023-05-01T00:00:00'),
(10, 10, '2023-05-01T14:30:00', '2023-06-10T00:00:00');

/*Vehículo*/
INSERT INTO Vehículos(Placa, TipoVehículo,  FechaRegistro,  Capacidad, Estado) 
VALUES
('ABC-123', 1, '2018/02/12', 20000,'Activo'),
INSERT INTO Vehículos(Placa, TipoVehículo,  FechaRegistro,  Capacidad, Estado) 
VALUES---falta
